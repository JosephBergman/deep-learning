...
![Example of a Neural Network](/assets/post01/nn-example.svg){:width="200px"}
...
![Example of a Perceptron](/assets/post01/perceptron-example.png)
...
![Perceptron Activation Function](/assets/post01/perceptron-activation.png){:height="200"}
...
![Sigmoid Activation Function](/assets/post01/sigmoid-activation.png){:height="200"}
...
![Hyperbolic Tangent Activation Function](/assets/post01/tanh-activation.jpg){:height="200"}
...
![ReLU Activation Function](/assets/post01/relu-activation.png){:height="200"}
...
### The Leaky ReLU
![Leaky ReLU Activation Function](/assets/post01/leaky-relu-activation.png){:height="200"}
...
![Neural Network Example](/assets/post01/nn-terminology-example.svg){:height="250"}
...
![Labeled Neural Network Example](/assets/post01/nn-example-labeled.svg){:height="250"}
